    ...
    <div className="min-h-screen bg-gradient-to-b from-background to-muted">
      <div className="max-w-4xl mx-auto px-4 py-12 space-y-8">
        ...
        <div className="flex justify-center">
          <CountdownTimer storageKey="explodely-ds3-timer" durationMinutes={10} />
        </div>
        ...
        <div className="bg-destructive/10 border border-destructive/20 rounded-lg p-6 text-center">
          <p className="font-semibold text-destructive mb-2">This is Your LAST Chance</p>
        ...
        <div className="text-center space-y-4">
          ...
          <a href="/app" className="text-sm text-muted-foreground hover:underline block">
