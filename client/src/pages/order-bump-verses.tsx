...
export default function OrderBumpVerses() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-background to-muted/30">
        ...
        <div className="max-w-3xl mx-auto space-y-8">
            ...
            <CardContent className="p-8 space-y-6">
              ...
              <div className="text-center space-y-4 pt-4">
                ...
                <div className="bg-muted/50 border-2 border-dashed border-muted-foreground/30 rounded-lg p-6">
                  <p className="text-sm text-muted-foreground mb-3">WarriorPlus Buy Button Will Appear Here</p>
                  <Button 
                    size="lg" 
                    className="w-full max-w-md text-lg py-6 bg-amber-500 hover:bg-amber-600 text-white"
                    data-testid="button-wplus-order-bump-buy"
                  >
          ...
          <div className="text-center">
            <Link 
              ...
              data-testid="link-wplus-skip-order-bump"
            >
              No thanks, I don't want the extra verses. Take me to my download.
            </Link>
          </div>
      ...
      <footer className="bg-muted/50 border-t py-8 mt-8">
          ...
          <div className="max-w-4xl mx-auto space-y-6">
            <div className="text-center space-y-4">
              ...
              <div className="text-xs text-muted-foreground leading-relaxed space-y-3">
                ...
                <p>
                  <strong>WARRIORPLUS DISCLOSURE:</strong> This product is sold through WarriorPlus marketplace. WarriorPlus is a trusted third-party payment processor. Your purchase is protected by WarriorPlus buyer protection policies.
                </p>
              </div>
            </div>
