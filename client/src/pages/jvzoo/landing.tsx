...
export default function JVZooLanding() {
  const faqs = [
    ...
    {
      question: "Can I really use this for JVZoo product launches?",
      answer: "Absolutely! Faith Funnels AI exports standalone HTML files that you can upload directly to any hosting provider. They're perfect for JVZoo, WarriorPlus, or any other marketplace."
    },
    {
  ...
  const features = [
    ...
    },
    {
      ...
      description: "Download complete HTML/ZIP packages ready for JVZoo, WarriorPlus & more."
    },
    {
      icon: Zap,
  ...
  const benefits = [
    ...
    "Perfect for JVZoo & WarriorPlus launches",
  ...
  return (
    <div className="min-h-screen select-none">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center max-w-6xl mx-auto">
            ...
            <div className="space-y-8">
              <div className="inline-block bg-primary/10 border border-primary/30 rounded-full px-6 py-2">
                <span className="text-sm font-semibold text-primary">JVZOO READY</span>
              </div>
      ...
      <section className="py-24 relative overflow-hidden" id="buy">
