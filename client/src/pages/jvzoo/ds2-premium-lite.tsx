  ...
  const faqs = [
    {
      ...
      answer: "Premium Lite includes 20 done-for-you templates - enough to cover most faith-based niches including churches, ministries, Christian coaches, and authors."
    },
    {
      question: "What's the difference between this and full Premium?",
      answer: "Full Premium has 50 templates and unlimited funnels. Premium Lite has 20 templates and 25 funnels - still plenty for most users at a lower price point."
    },
    {
      ...
      <div className="max-w-4xl mx-auto px-4 py-12 space-y-8">
        <div className="text-center space-y-4">
          ...
          <p className="text-xl text-muted-foreground">
            20 templates + 25 funnels at a reduced price!
          </p>
        </div>
        ...
        <div className="bg-card border rounded-lg p-8 space-y-6">
          ...
          <div className="space-y-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="font-semibold">20 Premium Templates</p>
        ...
        <div className="bg-muted rounded-lg p-6">
          ...
          <div className="grid grid-cols-3 gap-4 text-sm">
            ...
            <div className="text-center p-4 bg-primary/10 rounded-lg border-2 border-primary">
              ...
              <p className="text-muted-foreground">20 templates</p>
            </div>
            <div className="text-center p-4 bg-background rounded-lg border">
              ...
              <p className="text-muted-foreground">50 templates</p>
            </div>
          </div>
        </div>
