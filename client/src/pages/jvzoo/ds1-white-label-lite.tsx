      ...
      <div className="max-w-4xl mx-auto px-4 py-12 space-y-8">
        ...
        <div className="text-center space-y-4">
          <div className="flex flex-col items-center gap-2">
            <a href="https://www.jvzoo.com/b/115363/432247/99" data-testid="link-jvzoo-ds1">
              <img src="https://i.jvzoo.com/115363/432247/99" alt="" width="1" height="1" className="absolute" />
              <Button 
                size="lg" 
          ...
          <a href="https://www.jvzoo.com/nothanks/432247" className="text-sm text-muted-foreground hover:underline flex items-center justify-center gap-1" data-testid="link-no-thanks-ds1">
